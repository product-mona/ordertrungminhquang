        ...
        <div className={clsx(styles.wrapper, userPage && "!pl-0")}>
          ...
          >
            ...
            <BackTop className="!right-[2%]">
              <div className="hover:animate-bounce delay-2000">
                <i className="fas fa-angle-double-up text-[#fff] hover:text-[#eea387] bg-[#089efb] text-xl py-[14px] px-[18px] rounded-3xl shadow-xl hover:rounded-[12px]"></i>
              </div>
            </BackTop>
          </main>
